        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    preferenceName = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    userRoleDescription = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserRoless", x => x.userRoleId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUsers_UserRoless_UserRoleId",
                        column: x => x.UserRoleId,
                        principalTable: "UserRoless",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    courseViews = table.Column<int>(type: "INTEGER", nullable: true),
                    courseRating = table.Column<int>(type: "INTEGER", nullable: true),
                    courseApprovedBy = table.Column<int>(type: "INTEGER", nullable: true),
                    UserId = table.Column<string>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserPreferences", x => new { x.PreferenceId, x.UserId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppTags", x => new { x.TagName, x.CourseId });
                    table.ForeignKey(
                        name: "FK_AppTags_Courses_CourseId",
                        column: x => x.CourseId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    videoDescription = table.Column<string>(type: "TEXT", maxLength: 250, nullable: false),
